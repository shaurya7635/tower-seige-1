...
function setup() {
  ...
  block2 = new Block(411,230,40,40);
  block3 = new Block(452,230,40,40);
  block4 = new Block(493,230,40,40);


  //level two will contain three blocks (390,190,40,40);
  block5 = new Block(390,190,40,40);
  block6 = new Block(431,190,40,40);
  block7 = new Block(472,190,40,40);
